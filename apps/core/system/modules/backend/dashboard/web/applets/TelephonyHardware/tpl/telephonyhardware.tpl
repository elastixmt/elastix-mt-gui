<link rel="stylesheet" media="screen" type="text/css" href="web/apps/{$module_name}/applets/TelephonyHardware/tpl/css/styles.css" />
<script type='text/javascript' src='web/apps/{$module_name}/applets/TelephonyHardware/js/javascript.js'></script>
