<link rel="stylesheet" media="screen" type="text/css" href="web/apps/{$module_name}/applets/CommunicationActivity/tpl/css/styles.css" />
<script type='text/javascript' src='web/apps/{$module_name}/applets/CommunicationActivity/js/javascript.js'></script>
