<link rel="stylesheet" media="screen" type="text/css" href="web/apps/{$module_name}/applets/ProcessesStatus/tpl/css/styles.css" />
<script type='text/javascript' src='web/apps/{$module_name}/applets/ProcessesStatus/js/javascript.js'></script>
...
<img id="neo-applet-processes-processing" src="web/apps/{$module_name}/applets/ProcessesStatus/images/loading.gif" style="display: none;" alt="" />
</div>
{foreach from=$services item=infoServicio key=sServicio}
<div class="neo-applet-processes-row">
    <div class="neo-applet-processes-row-icon"><img src="web/apps/{$module_name}/applets/ProcessesStatus/images/{$infoServicio.icon}" width="32" height="28" alt="{$sServicio}" /></div>
    ...
    <div class="neo-applet-processes-row-menu">
        ...
        <img src="web/apps/{$module_name}/applets/ProcessesStatus/images/{$infoServicio.status_service_icon}" style="cursor:{$infoServicio.pointer_style};" width="15" height="15" alt="menu" />
    </div>
