  ...
  class AGI_AsteriskManager
  {
    ...
    */
	...
	function database_delTree($family) {
		$comand="database deltree $family";
		$r = $this->command($comand);
		return (bool)strstr($r["data"], "removed");
	}

	/** Prune technology for peer that use realtime technology
		@param string $tech -> type voip technology (sip or iax2)
		@param device $device  Name of the device that when prune
	*/
