<table width="100%" border="0" cellspacing="0" cellpadding="4" align="center">
    <tr class="moduleTitle">
        <td class="moduleTitle" valign="middle" colspan='2'>&nbsp;&nbsp;<img src="{$IMG}" width="40px" height="50px" border="0" align="absmiddle">&nbsp;&nbsp;{$title}</td>
    </tr>
    <tr class="letra12">
        <td align="left">
            <input class="button" type="submit" name="next_1_vega" value="{$NEXT}">&nbsp;&nbsp;
...
<div class="tabForm" style="font-size: 16px" width="100%">
	...
	<table border="0" width="100%" cellspacing="0" cellpadding="8" >
	    ...
	    <tr class="letra12">
		<td align="left" width="30%"><b>{$first_extension.LABEL}: </b></td>
		<td align="left">{$INFO12}&nbsp;&nbsp;&nbsp;&nbsp;{$first_extension_vega.INPUT}</td>
	    </tr>
  ...
  <!--         
    ...
    <br />
    <div id="voip_device_configuration">
        <table border="0" width="100%" cellspacing="0" cellpadding="8" >
            <tr class="letra12">
                <td align="left"><b style="color: rgb(227, 83, 50); font-size: 16px; font-family: 'Lucida Console';">{$voip_device_configuration}</b></td>
            </tr>
            <tr class="letra12">
                <td align="left" width="30%"><b>{$registration.LABEL}:</b></td>
                <td align="left">{$INFO27}&nbsp;&nbsp;&nbsp;&nbsp;{$registration.INPUT}</td>
            </tr>
            <tr class="letra12">
                <td align="left" width="30%"><b>{$registration_password.LABEL}:</b></td>
                <td align="left">{$INFO28}&nbsp;&nbsp;&nbsp;&nbsp;{$registration_password.INPUT}</td>
            </tr>
