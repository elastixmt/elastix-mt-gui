...
{{#view App.PBXPanelView controllerBinding="extensions" }}
	...
	{{/view}}
	{{else}}
	<img class="icon" src="web/apps/{/literal}{$module_name}{literal}/images/loading.gif"/>
	{{/if}}
{{/view}}
{/literal}
...
<div style="float:left; border: black solid 0px;">
	...
	<img src="web/apps/{$module_name}/images/info.png"/>
	<div>
		{literal}
...
<div style="float: right; border: black solid 0px;">
	<a class="pbxtooltip" href="#" {{action "dialvoicemail" this on="doubleClick"}}>
		<img class="icon" src="web/apps/{/literal}{$module_name}{literal}/images/mail.png"/>
...
{literal}
<div style="float: right; border: black solid 0px;">
    <img class="icon" src="web/apps/{/literal}{$module_name}{literal}/images/icon_trunk2.png"/>
</div>
{/literal}
</script>
...
<div style="float: right; border: black solid 0px;">
    <img class="icon" src="web/apps/{$module_name}/images/icon_trunk2.png"/>
</div>
</script>
...
<div style="float: right; border: black solid 0px;">
    {literal}{{view App.DroppableIconView icon="{/literal}web/apps/{$module_name}/images/queue.png{literal}" }}{/literal}
</div>
</script>
...
<div style="float: right; border: black solid 0px;">
    {literal}{{view App.DroppableIconView icon="{/literal}web/apps/{$module_name}/images/conference.png{literal}" }}{/literal}
</div>
</script>
...
<div style="float: right; border: black solid 0px;">
	{literal}{{view App.DroppableIconView icon="{/literal}web/apps/{$module_name}/images/parking.png{literal}" }}{/literal}
</div>
</script>
