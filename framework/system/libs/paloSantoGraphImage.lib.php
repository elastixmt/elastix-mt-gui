...
global $arrConf;
if($G_MODULE != ''){
    require_once("apps/$G_MODULE/libs/$G_CLASS.class.php");//lib del modulo
    require_once("apps/$G_MODULE/configs/default.conf.php");//archivo configuracion del modulo
    ...
    require_once("configs/default.conf.php");//archivo de configuracion general
...
*/                        
                ...
                $source2 = imagecreatefrompng("/var/www/html/web/_common/images/pie_alpha.png");
    ...
    else if ($G_TYPE == 'gauge')
    {
        if (!function_exists('displayGraph_draw_gauge')) {
            function displayGraph_draw_gauge($canvasx, $percent) {
                ...
                $source = imagecreatefrompng("/var/www/html/web/_common/images/gauge_base.png");
                ...
                $source2 = imagecreatefrompng("/var/www/html/web/_common/images/gauge_center.png");
                imagealphablending($source2, true);
